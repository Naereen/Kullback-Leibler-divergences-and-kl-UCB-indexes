...
static PyMethodDef kullback_leibler_cMethods[] = {
    ...
    {"klGamma", klGamma, METH_VARARGS, "klGamma(x, y, a): Calculate the Kullback-Leibler for Gamma distributions."},
...
PyMODINIT_FUNC initkullbackleiblerc(void) {
        return Py_InitModule("kullback_leibler_c", kullback_leibler_cMethods);
        import_array();
};
